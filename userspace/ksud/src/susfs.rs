...
pub fn add_sus_kstat_statically(
    ...
    let mut cmd = SusfsSusKstat {
        ...
        spoofed_atime_tv_nsec,
        spoofed_mtime_tv_sec,
        spoofed_mtime_tv_nsec,
        spoofed_ctime_tv_sec,
        spoofed_ctime_tv_nsec,
        spoofed_blocks,
        spoofed_blksize,
        flags,
        err: ERR_CMD_NOT_SUPPORTED,
